...
{tab==="brands"&&<div style={{padding:"14px"}}><h3>Advertise - Will show on Home top</h3><div style={{background:"#fff",padding:"14px",borderRadius:14,border:"1px solid #e5e7eb"}}><input value={adC} onChange={e=>setAdC(e.target.value)} placeholder="Company" style={{width:"100%",padding:10,marginBottom:8,borderRadius:8,border:"1px solid #ddd"}}/><input value={adT} onChange={e=>setAdT(e.target.value)} placeholder="Title" style={{width:"100%",padding:10,marginBottom:8,borderRadius:8,border:"1px solid #ddd"}}/><input value={adL} onChange={e=>setAdL(e.target.value)} placeholder="Link https://" style={{width:"100%",padding:10,marginBottom:8,borderRadius:8,border:"1px solid #ddd"}}/><select value={adP} onChange={e=>setAdP(e.target.value)} style={{width:"100%",padding:10,borderRadius:8,border:"1px solid #ddd"}}><option>Basic - N20k</option><option>Premium - N50k</option><option>Gold - N100k</option></select><input type="file" accept="image/*" onChange={upAd} style={{marginTop:8}}/><button onClick={postAd} style={{width:"100%",marginTop:12,padding:12,background:"#0A1931",color:"#FFD700",border:"none",borderRadius:10,fontWeight:"bold"}}>Post Ad - Shows on Home</button></div></div>}
