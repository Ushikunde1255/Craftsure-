...
const sendOtp=()=>{if(awhat.length<10)return alert("Enter valid phone");const c=Math.floor(100000+Math.random()*900000).toString();setOtpSent(c);alert("CraftSure NG code: "+c);};
